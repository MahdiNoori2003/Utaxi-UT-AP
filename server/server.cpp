...
Server::Server(std::string _locations_file,int _port) : port(_port) {
  notFoundHandler = new NotFoundHandler();
  app_manager=new Manager(_locations_file);
...
Manager* Server::activate_api(){
  return app_manager;
}

Response* Server::handle_errors(::Exception& e){
